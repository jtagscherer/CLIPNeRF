...
do
  ...
  do
    ...
    python run_nerf_clip.py --expname ${expname} --config configs/${dataset}.txt --use_clip --w_clip 1.0 --description "${formatted_query}" --ft_path checkpoints/${dataset}.tar --sample_scale 32 --i_print 5000 --i_img 5000 --i_weights 5000 --i_testset 5000 --i_video 5000
  done
done
